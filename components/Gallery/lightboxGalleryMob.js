    ...
    <div className="main-car-section">
        ...
        <div className="thumbnail-grid">
          {images.slice(1, 8).map((img, i) => {
            ...
            return (
              ...
              >
                <Image src={img.src} alt={`Thumbnail ${i + 1}`} />
      ...
      <div className="car-bio">
        <div className="details">
          ...
          <div className="sub-details">
            <p>S54 6-Cylinder, Imola Red Interior, Rod Bearings Replaced</p>
          </div>
        </div>
        <div className="btns">
      ...
      <div className="breadcrumb">
        <ul>
          ...
          <li><a href="#">Automatic (6-Speed)</a></li>
          <Image src={Right} alt="arrow" />
          <li><a href="#">BMW</a></li>
          <Image src={Right} alt="arrow" />
          <li><a href="#">E46 M3</a></li>
          <Image src={Right} alt="arrow" />
          <li><a href="#">2002</a></li>
        </ul>
      </div>
      ...
      {isOpen && (
        <div className="lightbox" onClick={closeLightbox}>
          ...
          <Image src={images[currentIndex].src} alt="enlarged" className="lightbox-img" />
      ...
      {showAllPhotos && (
        <div className="all-photos-overlay">
          <div className="all-photos-header">
            <div className="tabs">
              {["All", "Exterior", "Interior", "Mechanical", "Docs", "Other"].map(
                (cat) => (
                  <span
                    key={cat}
          ...
          <div className="all-photos-grid">
            {filteredImages.map((img, index) => (
              ...
              >
                <Image src={img.src} alt={`Photo ${index}`} />
              </div>
            ))}
          </div>
        </div>
